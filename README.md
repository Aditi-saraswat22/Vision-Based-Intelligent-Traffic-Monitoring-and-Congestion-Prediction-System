...
# Traffic Congestion Detection using Computer Vision

This project detects vehicles from traffic footage and estimates traffic density to predict congestion.
